...
from quantagent.api.routes.traces import router as traces_router
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    # Constructing an engine/cache/LLM client/retriever here does no I/O by
    # itself (all are lazy, including the embedding/reranker models
